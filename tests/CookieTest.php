...
class Zend_Http_CookieTest extends TestCase
{
     ...
     */
    public function testSetInvalidName($char): void
    {
     ...
     */
    public function testGetName($cStr, $cInfo): void
    {
     ...
     */
    public function testGetValueConstructor($val): void
    {
     ...
     * @dataProvider validCookieValueProvider
     */
    public function testGetValueFromString($val): void
    {
     ...
     * @dataProvider validCookieValueProvider
     */
    public function testGetRawValueFromString($val): void
    {
     ...
     * @dataProvider validCookieValueProvider
     */
    public function testGetRawValueFromStringToString($val): void
    {
        // Because ';' has special meaning in the cookie, strip it out for this test.
        $val = str_replace(';', '', $val);
        $cookie = Zend_Http_Cookie::fromString('cookie=' . $val . '; domain=example.com', null, false);
     ...
     * @dataProvider validCookieValueProvider
     */
    public function testGetValueFromStringEncodedToString($val): void
    {
        // Because ';' has special meaning in the cookie, strip it out for this test.
        $val = str_replace(';', '', $val);
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testGetDomainInStr($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     */
    public function testGetDomainInRefUrl(Zend_Uri $uri): void
    {
        $domain = $uri->getHost();
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testGetPathInStr($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     * @dataProvider refUrlProvider
     */
    public function testGetPathInRefUrl(Zend_Uri $uri): void
    {
        $path = $uri->getPath();
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testGetExpiryTime($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testIsSecure($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     */
    public function testIsExpired($cStr, $expired): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     */
    public function testIsExpiredDifferentTime(): void
    {
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testIsSessionCookie($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
     ...
     * @dataProvider validCookieWithInfoProvider
     */
    public function testToString($cStr, $cInfo): void
    {
        $cookie = Zend_Http_Cookie::fromString($cStr);
        if (! $cookie instanceof Zend_Http_Cookie) {
            $this->fail("Failed creating a cookie object from '$cStr'");
    ...
    public function testGarbageInStrIsIgnored(): void
    {
        $cookies = array(
     ...
     */
    public function testMatchDomain($cookieStr, $uri, $match): void
    {
        $cookie = Zend_Http_Cookie::fromString($cookieStr);
        $this->assertEquals($match, $cookie->match($uri));
    }

    public static function domainMatchTestProvider(): array
    {
    ...
    public function testMatchSecure(): void
    {
    ...
    public function testMatchExpire(): void
    {
    ...
    public function testFromStringFalse(): void
    {
    ...
    public function testZF5690OverflowingExpiryDate(): void
    {
    ...
    public function testPregMatchIsQuoted(): void
    {
    ...
    public static function invalidCookieNameCharProvider(): array
    {
        return array(
            array("="),
            array(","),
    ...
    public static function validCookieValueProvider(): array
    {
        return array(
            array('simpleCookie'),
            array('space cookie'),
            array('!@#$%^*&()* ][{}?;'),
            array("line\n\rbreaks"),
            array("0000j8CydACPu_-J9bE8uTX91YU:12a83ks4k"),
            // Long cookie value - 2kb
            array(str_repeat(md5(time()), 64))
        );
    }

    public static function refUrlProvider(): array
    {
        return array(
    ...
    public static function cookieWithExpiredFlagProvider(): array
    {
        return array(
